...
const storyLines = [
  "This is not a Valentine's message.",
  "",
  "That month.. it wasn't easy, it was so long.",
  "There was silence, reflection and space.",
  "Your presence always made a difference.",
  "and your absence left a quiet void",
  "",
  "I'm still working on myself so I can handle the future",
  "Not to prove anything",
  "Just to be the person I'm meant to be.",
  "",
  "And through all of this",
  "I still carry more love to you.",
  "",
  "I'm sorry time have to heal by time, not by me.",
  "I'm happy to see my prayers working, and Allah listening to me.",
  "What made me more patient.",
  "",
  "Even the smallest memory of you, can bring warmth to a quiet moment,",
